...
difficulty, please reach out to us at
...
**Osprey crashes with ‘Unrecognized function or variable lgamma’:**
   ...
   Make sure that you have added SPM-12 **without** subfolders (See
   `Instalation
   intructions <https://schorschinho.github.io/osprey/getting-started.html#installing-osprey>`__).
...
data…’:**
   ...
   genrate a matching basis-set yourself. Or, if a matching option is
